...
public class ESPBaseDB {
    ...
    private String get11(){
        return "PINO (GPIO 11):\n\n" +
                "- Não é recomendável o uso deste pino;\n" +
                "- Pode funcionar como entrada ou saída de nível lógico;\n" +
                "- Possui Saída PWM;\n" +
                "- Com função SPI CS0;\n" +
                "- Com função comunicação serial RTS1;\n";
    }
    private String get10(){
        return "PINO (GPIO 10):\n\n" +
                ...
                "- Possui Saída PWM;\n" +
                "- Com função SPI WP;\n" +
                "- Com função comunicação serial TX1;\n";
    }
    private String get09(){
        return "PINO (GPIO 9):\n\n" +
                ...
                "- Possui Saída PWM;\n" +
                "- Com função SPI HD;\n" +
                "- Com função comunicação serial RX1;\n";
    }
    private String get08(){
        return "PINO (GPIO 8):\n\n" +
                ...
                "- Possui Saída PWM;\n" +
                "- Com função SPI D;\n" +
                "- Com função comunicação serial CTS2;\n";
    }
    private String get07(){
        return "PINO (GPIO 7):\n\n" +
                ...
                "- Possui Saída PWM;\n" +
                "- Com função SPI Q;\n" +
                "- Com função comunicação serial RTS2;\n";
    }
    private String get06(){
        return "PINO (GPIO 6):\n\n" +
                ...
                "- Possui Saída PWM;\n" +
                "- Com função SPI CLK;\n" +
                "- Com função comunicação serial CTS1;\n";
    }
